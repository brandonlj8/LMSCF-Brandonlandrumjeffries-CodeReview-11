...
$result3=mysqli_query($conn, "SELECT * FROM animal WHERE age < 8");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  <a class="navbar-brand" href="#">Petz Adopt</a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    ...
    <form id='formData' class="form-inline my-2 my-lg-0">
     ...
     <a  href="logout.php?logout">Sign Out</a> 
            ...
            <h2 align='center'>Welcome Back <?php echo $userRow['userName' ]; ?></h2>
